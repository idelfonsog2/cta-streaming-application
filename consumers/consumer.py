...
from confluent_kafka.avro import AvroConsumer, CachedSchemaRegistry
...
class KafkaConsumer:
    ...
    def __init__(
        ...
        if is_avro is True:
            ...
            self.broker_properties["auto.offset.reset"] = "earliest" if self.offset_earliest else "beginning",
